...
fn emit_instr(instr: &Instr, atoms: &AtomTable, out: &mut String) -> Result<(), EmitError> {
    match instr {
        ...
        Instr::PutInt { ai, value } => wf(out, format_args!("    PUT_CONST A{ai}, int({value})")),
        ...
        Instr::GetVal { ai, xi } => wf(out, format_args!("    GET_VAL X{xi}, A{ai}")),
        Instr::GetYVar { ai, yi } => wf(out, format_args!("    GET_Y_VAR Y{yi}, A{ai}")),
        Instr::GetConst { ai, atom } => emit_get_const(*ai, *atom, atoms, out),
        Instr::GetInt { ai, value } => wf(out, format_args!("    GET_CONST A{ai}, int({value})")),
        ...
        Instr::UnifyInt { value } => wf(out, format_args!("    UNIFY_CONST int({value})")),
